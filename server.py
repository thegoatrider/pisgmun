...
DB_DEFAULT_COMMITTEES = {
  "ecosoc": {
    ...
    "grade": 8,
    "description": "ECOSOC deals with international economic, social, cultural, educational, and health matters.",
    "agenda": "Ensuring Transparency and Sustainability in Food Supply Chains in the Age of Online Commerce",
    "eb_chair": "Aanya Sharma", "eb_vice_chair": "Kabir Mehta", "eb_rapporteur": "Sneha Iyer",
    "rules": "Standard UN Rules of Procedure (RoP) apply.",
    "prepare_info": "Research global food supply chain structures and ecommerce.",
    "resources": [{"title": "ECOSOC Background Guide 2026", "url": "#"}],
    "schedule": "Day 1: Opening & GSL | Day 2: Resolution Drafting & Voting",
  ...
  "un-women": {
    ...
    "name": "UN Women",
    "grade": 9,
    "description": "UN Women is the UN entity dedicated to gender equality and the empowerment of women.",
    "agenda": "Addressing Challenges to Women’s Rights and Empowerment",
    "eb_chair": "Kiara Sen", "eb_vice_chair": "Rohan Joshi", "eb_rapporteur": "Aditya Patel",
    "rules": "Standard UN Rules of Procedure (RoP) apply.",
    "prepare_info": "Examine national gender parity statistics and barriers.",
    "resources": [{"title": "UN Women Background Guide 2026", "url": "#"}],
    "schedule": "Day 1: Opening & GSL | Day 2: Resolution Drafting & Voting",
    "capacity": 50, "status": "OPEN"
  },
  "unhrc": {
    ...
    "grade": 10,
    "description": "UNHRC promotes and protects human rights around the globe.",
    "agenda": "Protecting Digital Rights during Conflicts",
    "eb_chair": "Aarav Singh", "eb_vice_chair": "Meera Sen", "eb_rapporteur": "Rishi Gupta",
    "rules": "Standard UN Rules of Procedure (RoP) apply.",
    "prepare_info": "Review privacy rights, censorship during conflicts, and digital sovereignty.",
    "resources": [{"title": "UNHRC Background Guide 2026", "url": "#"}],
    "schedule": "Day 1: Opening & GSL | Day 2: Resolution Drafting & Voting",
  ...
  "fao": {
    ...
    "grade": 9,
    "description": "FAO leads international efforts to defeat hunger and improve nutrition.",
    "agenda": "Addressing the Crisis of Food Insecurity in Conflict Areas",
    "eb_chair": "Ananya Roy", "eb_vice_chair": "Dev Kar", "eb_rapporteur": "Tara Sen",
    "rules": "Standard UN Rules of Procedure (RoP) apply.",
    "prepare_info": "Examine food security indicators in active war zones.",
    "resources": [{"title": "FAO Background Guide 2026", "url": "#"}],
    "schedule": "Day 1: Opening & GSL | Day 2: Resolution Drafting & Voting",
    "capacity": 40, "status": "OPEN"
  },
  "unep": {
    ...
    "grade": 8,
    "description": "UNEP coordinates environmental activities and assists developing nations.",
    "agenda": "Harnessing Solar Energy for Equitable Access and Clean Air",
    "eb_chair": "Vihaan Patel", "eb_vice_chair": "Diya Mehta", "eb_rapporteur": "Arjun Rao",
    "rules": "Standard UN Rules of Procedure (RoP) apply.",
    "prepare_info": "Examine solar capacity metrics and clean energy tech transfer.",
    "resources": [{"title": "UNEP Background Guide 2026", "url": "#"}],
    "schedule": "Day 1: Opening & GSL | Day 2: Resolution Drafting & Voting",
    "capacity": 50, "status": "OPEN"
  },
  "unicef": {
    ...
    "grade": 10,
    "description": "UNICEF advocates for children's safety, education, and health worldwide.",
    "agenda": "Impact of Foreign Aid Reductions on Global Child Healthcare",
    "eb_chair": "Kabir Roy", "eb_vice_chair": "Isha Joshi", "eb_rapporteur": "Aanya Patel",
    "rules": "Standard UN Rules of Procedure (RoP) apply.",
    "prepare_info": "Examine healthcare funding models and child mortality trends.",
    "resources": [{"title": "UNICEF Background Guide 2026", "url": "#"}],
    "schedule": "Day 1: Opening & GSL | Day 2: Resolution Drafting & Voting",
    "capacity": 40, "status": "OPEN"
  }
}
